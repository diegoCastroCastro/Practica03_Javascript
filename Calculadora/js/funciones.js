...
function porcentaje() {
    ...
    pantalla.innerHTML = x; //mostrar en pantalla
    igual() //resolver y mostrar operaciones pendientes
...
function teclado(elEvento) {
    ...
    if (k == 106) { operacion('*') } //tecla multiplicación
    if (k == 107) { operacion('+') } //tecla suma
    if (k == 109) { operacion('-') } //tecla resta
    if (k == 111) { operacion('/') } //tecla división
